...
// 모델 내에서 offeredMenu(풀 메뉴) 말고 관측된 "축소 메뉴"들의 최대 W 목록 — 듀얼포트 어댑터가
// 다른 포트와 전력을 분배할 때 협상하는 메뉴들이다. offeredMenu와 같은 최대 W는 제외, 반올림해
// 중복 제거, 내림차순. 메뉴가 한 종류뿐이면(=풀 메뉴만 관측) 빈 배열.
